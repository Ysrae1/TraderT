...
def main_train(process_param):
    ...
    hdf5_filename = 'lob_data_train.h5'
    ...
    with h5py.File(os.path.join(output_dir, hdf5_filename), 'w') as h5f:
        ...
        with ThreadPoolExecutor() as executor:
            ...
            future_to_file = {executor.submit(process_file, file, process_param): file for file in csv_files}
...
def main_ve_te(process_param):
    ...
    output_dir = 'data/lob_data'
    hdf5_filename_v = 'lob_data_verif.h5'
    hdf5_filename_t = 'lob_data_test.h5'
